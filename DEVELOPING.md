...
1. run `docker-compose build syft` to build the local development container
2. run `docker-compose run --rm syft bash` to enter into the container with all the bootstrapped dependencies installed.
