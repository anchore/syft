...
// This file was generated by robots at 2021-09-29 23:22:33.545777 -0400 EDT m=+0.210083138
...
var licenseIDs = map[string]string{
	...
	"copyleft-next-0.3":                        "copyleft-next-0.3.1",
	...
	"gfdl-1-invariants-or-later":               "GFDL-1.3-invariants-or-later",
	"gfdl-1-no-invariants-only":                "GFDL-1.2-no-invariants-only",
	"gfdl-1-no-invariants-or-later":            "GFDL-1.1-no-invariants-or-later",
	"gfdl-1-only":                              "GFDL-1.2-only",
	"gfdl-1-or-later":                          "GFDL-1.2-or-later",
	"gfdl-1.1":                                 "GFDL-1.1",
	...
	"lgpl-2":                                   "LGPL-2.0",
	"lgpl-2+":                                  "LGPL-2.0+",
	"lgpl-2-only":                              "LGPL-2.1-only",
	"lgpl-2-or-later":                          "LGPL-2.1-or-later",
	"lgpl-2.0":                                 "LGPL-2.0",
	"lgpl-2.0+":                                "LGPL-2.0+",
