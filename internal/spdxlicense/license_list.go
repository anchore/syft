...
var licenseIDs = map[string]string{
	...
	"briangladman3.0.0clausenoconversion":   "Brian-Gladman-3-Clause-no-conversion",
	"briangladman3.0clause":                 "Brian-Gladman-3-Clause",
	"briangladman3.0clausenoconversion":     "Brian-Gladman-3-Clause-no-conversion",
	"briangladman3clause":                   "Brian-Gladman-3-Clause",
	"briangladman3clausenoconversion":       "Brian-Gladman-3-Clause-no-conversion",
	...
	"bsd2.0.0clauseposunchanged":            "BSD-2-Clause-pos-unchanged",
	...
	"bsd2.0clauseposunchanged":              "BSD-2-Clause-pos-unchanged",
	...
	"bsd2clauseposunchanged":                "BSD-2-Clause-pos-unchanged",
	...
	"bsd3.0.0clauseopenwebui":               "BSD-3-Clause-OpenWebUI",
	...
	"bsd3.0clauseopenwebui":                 "BSD-3-Clause-OpenWebUI",
	...
	"bsd3clauseopenwebui":                   "BSD-3-Clause-OpenWebUI",
	...
	"bsdasktoendorse":                       "BSD-ask-to-endorse",
	...
	"bsdsourcealtgpl":                       "BSD-Source-alt-GPL",
	"bsdsourcebeginningfile":                "BSD-Source-beginning-file",
	"bsdsourcecode":                         "BSD-Source-Code",
	"bsdsourcecodenodisclaimer":             "BSD-Source-Code-no-disclaimer",
	...
	"ccbync3.0.0igo":                        "CC-BY-NC-3.0-IGO",
	"ccbync3.0de":                           "CC-BY-NC-3.0-DE",
	"ccbync3.0igo":                          "CC-BY-NC-3.0-IGO",
	"ccbync3de":                             "CC-BY-NC-3.0-DE",
	"ccbync3igo":                            "CC-BY-NC-3.0-IGO",
	...
	"hippocratic3.0.0core":                  "Hippocratic-3.0-core",
	"hippocratic3.0core":                    "Hippocratic-3.0-core",
	"hippocratic3core":                      "Hippocratic-3.0-core",
	"hp1986":                                "HP-1986",
	"hp1986.0":                              "HP-1986",
	"hp1986.0.0":                            "HP-1986",
	"hp1989":                                "HP-1989",
...
var urlToLicense = map[string]string{
	...
	"cgit.freebsd.org/src/plain/sys/dev/aic7xxx/aic7xxx_osm.c":                                                     "BSD-Source-alt-GPL",
	"cgit.freebsd.org/src/tree/usr.bin/sockstat/sockstat.c":                                                        "BSD-2-Clause-pos-unchanged",
	...
	"creativecommons.org/licenses/by-nc/3.0/igo/legalcode":                                                         "CC-BY-NC-3.0-IGO",
	...
	"docs.mvt.re/en/latest/license/":                                                                               "MVT-1.1",
	...
	"firstdonoharm.dev/version/3/0/core.txt":                                                                       "Hippocratic-3.0-core",
	...
	"github.com/Fraunhofer-IIS/mpeghdec/blob/main/LICENSE.txt":                                                                               "FDK-MPEG-H",
	...
	"github.com/PicoEFI/PicoEFI/blob/2263ac1a2bc98e5534d64a4896d3cfbbae00745a/LICENSES/LicenseRef-scancode-bsd-no-disclaimer-unmodified.txt": "BSD-Source-Code-no-disclaimer",
	...
	"github.com/freebsd/pkg/blob/main/src/add.c":                                                                                                                          "BSD-2-Clause-pos-unchanged",
	...
	"github.com/krb5/krb5/blob/kfw-4.0.1-beta1/src/lib/crypto/builtin/aes/aesopt.h":                                                                                       "Brian-Gladman-3-Clause-no-conversion",
	...
	"github.com/libarchive/libarchive/blob/master/libarchive_fe/line_reader.c":                                                                                            "BSD-2-Clause-pos-unchanged",
	...
	"github.com/mvt-project/mvt/blob/main/LICENSE":                                                                                                                        "MVT-1.1",
	...
	"github.com/open-webui/open-webui/blob/main/LICENSE":                                                                                                                  "BSD-3-Clause-OpenWebUI",
	...
	"github.com/sudo-project/sudo/blob/c1307ea9ff340ce0538779f8e456501461fc44b7/plugins/sudoers/redblack.c#L24-L43":                                                       "BSD-ask-to-endorse",
	...
	"github.com/vattam/BSDGames/blob/master/atc/extern.c#L36":                                                                                                             "atc-game",
	...
	"gitlab.freedesktop.org/dbus/dbus/-/blob/789d97ad53044f94351a958e785c2923643b346a/COPYING#L11-207":                                                                    "AFL-2.1",
	...
	"gitlab.freedesktop.org/xorg/xserver/-/blob/dd5c2595a42d3ff0c4f18d9b53d1f6c3fd934fd4/COPYING#L365-389":                                                                "MIT",
	...
	"interoperable-europe.ec.europa.eu/sites/default/files/inline-files/EUPL%20v1_2%20EN(1).txt":                                                                          "EUPL-1.2",
	...
	"opensource.org/license/0BSD":                                                                                    "0BSD",
	"opensource.org/license/AAL":                                                                                     "AAL",
	"opensource.org/license/AFL-3.0":                                                                                 "AFL-3.0",
	"opensource.org/license/AGPL-3.0":                                                                                "AGPL-3.0-or-later",
	"opensource.org/license/AGPL-3.0-only":                                                                           "AGPL-3.0-only",
	"opensource.org/license/APL-1.0":                                                                                 "APL-1.0",
	"opensource.org/license/Artistic-1.0":                                                                            "Artistic-1.0-cl8",
	"opensource.org/license/Artistic-2.0":                                                                            "Artistic-2.0",
	"opensource.org/license/BSD-2-Clause":                                                                            "BSD-2-Clause",
	"opensource.org/license/BSD-2-Clause-Patent":                                                                     "BSD-2-Clause-Patent",
	"opensource.org/license/BSD-3-Clause":                                                                            "BSD-3-Clause",
	"opensource.org/license/BSL-1.0":                                                                                 "BSL-1.0",
	"opensource.org/license/CAL-1.0":                                                                                 "CAL-1.0-Combined-Work-Exception",
	"opensource.org/license/CATOSL-1.1":                                                                              "CATOSL-1.1",
	"opensource.org/license/CDDL-1.0":                                                                                "CDDL-1.0",
	"opensource.org/license/CNRI-Python":                                                                             "CNRI-Python",
	"opensource.org/license/CNRI-Python-GPL-Compatible":                                                              "CNRI-Python-GPL-Compatible",
	"opensource.org/license/CPAL-1.0":                                                                                "CPAL-1.0",
	"opensource.org/license/CPL-1.0":                                                                                 "CPL-1.0",
	"opensource.org/license/CUA-OPL-1.0":                                                                             "CUA-OPL-1.0",
	"opensource.org/license/ECL-1.0":                                                                                 "ECL-1.0",
	"opensource.org/license/ECL-2.0":                                                                                 "ECL-2.0",
	"opensource.org/license/EFL-1.0":                                                                                 "EFL-1.0",
	"opensource.org/license/EFL-2.0":                                                                                 "EFL-2.0",
	"opensource.org/license/EPL-1.0":                                                                                 "EPL-1.0",
	"opensource.org/license/EUDatagrid":                                                                              "EUDatagrid",
	"opensource.org/license/EUPL-1.1":                                                                                "EUPL-1.1",
	"opensource.org/license/EUPL-1.2":                                                                                "EUPL-1.2",
	"opensource.org/license/Entessa":                                                                                 "Entessa",
	"opensource.org/license/Fair":                                                                                    "Fair",
	"opensource.org/license/Frameworx-1.0":                                                                           "Frameworx-1.0",
	"opensource.org/license/GPL-2.0":                                                                                 "GPL-2.0-or-later",
	"opensource.org/license/GPL-2.0-only":                                                                            "GPL-2.0-only",
	"opensource.org/license/GPL-3.0":                                                                                 "GPL-3.0-or-later",
	"opensource.org/license/GPL-3.0-only":                                                                            "GPL-3.0-only",
	"opensource.org/license/HPND":                                                                                    "HPND",
	"opensource.org/license/IPA":                                                                                     "IPA",
	"opensource.org/license/IPL-1.0":                                                                                 "IPL-1.0",
	"opensource.org/license/ISC":                                                                                     "ISC",
	"opensource.org/license/Intel":                                                                                   "Intel",
	"opensource.org/license/LGPL-2.1":                                                                                "LGPL-2.1-or-later",
	"opensource.org/license/LGPL-2.1-only":                                                                           "LGPL-2.1-only",
	"opensource.org/license/LGPL-3.0":                                                                                "LGPL-3.0-or-later",
	"opensource.org/license/LPL-1.0":                                                                                 "LPL-1.0",
	"opensource.org/license/LPL-1.02":                                                                                "LPL-1.02",
	"opensource.org/license/LPPL-1.3c":                                                                               "LPPL-1.3c",
	"opensource.org/license/LiLiQ-P-1.1":                                                                             "LiLiQ-P-1.1",
	"opensource.org/license/LiLiQ-R-1.1":                                                                             "LiLiQ-R-1.1",
	"opensource.org/license/LiLiQ-Rplus-1.1":                                                                         "LiLiQ-Rplus-1.1",
	"opensource.org/license/MIT":                                                                                     "MIT",
	"opensource.org/license/MPL-1.0":                                                                                 "MPL-1.0",
	"opensource.org/license/MPL-1.1":                                                                                 "MPL-1.1",
	"opensource.org/license/MPL-2.0":                                                                                 "MPL-2.0-no-copyleft-exception",
	"opensource.org/license/MS-PL":                                                                                   "MS-PL",
	"opensource.org/license/MS-RL":                                                                                   "MS-RL",
	"opensource.org/license/MirOS":                                                                                   "MirOS",
	"opensource.org/license/Motosoto":                                                                                "Motosoto",
	"opensource.org/license/Multics":                                                                                 "Multics",
	"opensource.org/license/NASA-1.3":                                                                                "NASA-1.3",
	"opensource.org/license/NCSA":                                                                                    "NCSA",
	"opensource.org/license/NGPL":                                                                                    "NGPL",
	"opensource.org/license/NPOSL-3.0":                                                                               "NPOSL-3.0",
	"opensource.org/license/NTP":                                                                                     "NTP",
	"opensource.org/license/Naumen":                                                                                  "Naumen",
	"opensource.org/license/Nokia":                                                                                   "Nokia",
	"opensource.org/license/OCLC-2.0":                                                                                "OCLC-2.0",
	"opensource.org/license/OFL-1.1":                                                                                 "OFL-1.1-no-RFN",
	"opensource.org/license/OGTSL":                                                                                   "OGTSL",
	"opensource.org/license/OLFL-1.3":                                                                                "OLFL-1.3",
	"opensource.org/license/OSC-1.0":                                                                                 "OSC-1.0",
	"opensource.org/license/OSET-PL-2.1":                                                                             "OSET-PL-2.1",
	"opensource.org/license/OSL-1.0":                                                                                 "OSL-1.0",
	"opensource.org/license/OSL-2.1":                                                                                 "OSL-2.1",
	"opensource.org/license/OSL-3.0":                                                                                 "OSL-3.0",
	"opensource.org/license/PHP-3.0":                                                                                 "PHP-3.0",
	"opensource.org/license/PSF-2-0":                                                                                 "PSF-2.0",
	"opensource.org/license/PostgreSQL":                                                                              "PostgreSQL",
	"opensource.org/license/Python-2.0":                                                                              "Python-2.0",
	"opensource.org/license/Python-2.0.1":                                                                            "Python-2.0.1",
	"opensource.org/license/QPL-1.0":                                                                                 "QPL-1.0",
	"opensource.org/license/RPL-1.1":                                                                                 "RPL-1.1",
	"opensource.org/license/RPL-1.5":                                                                                 "RPL-1.5",
	"opensource.org/license/RPSL-1.0":                                                                                "RPSL-1.0",
	"opensource.org/license/RSCPL":                                                                                   "RSCPL",
	"opensource.org/license/SISSL":                                                                                   "SISSL",
	"opensource.org/license/SPL-1.0":                                                                                 "SPL-1.0",
	"opensource.org/license/SiMPL-2.0":                                                                               "SimPL-2.0",
	"opensource.org/license/Sleepycat":                                                                               "Sleepycat",
	"opensource.org/license/UCL-1.0":                                                                                 "UCL-1.0",
	"opensource.org/license/UPL-1.0":                                                                                 "UPL-1.0",
	"opensource.org/license/VSL-1.0":                                                                                 "VSL-1.0",
	"opensource.org/license/W3C":                                                                                     "W3C",
	"opensource.org/license/Watcom-1.0":                                                                              "Watcom-1.0",
	"opensource.org/license/Xnet":                                                                                    "Xnet",
	"opensource.org/license/ZPL-2.0":                                                                                 "ZPL-2.0",
	"opensource.org/license/Zlib":                                                                                    "Zlib",
	"opensource.org/license/apache-1.1":                                                                              "Apache-1.1",
	"opensource.org/license/apache-2.0":                                                                              "Apache-2.0",
	"opensource.org/license/curl":                                                                                    "curl",
	...
	"raw.githubusercontent.com/landtuna/open-mtools/6c04c2882eca7c4313ec267766ea53ac9bfe129b/mdump.c": "Informatica",
	"raw.githubusercontent.com/landtuna/open-mtools/6c04c2882eca7c4313ec267766ea53ac9bfe129b/msend.c": "Informatica",
	...
	"scancode-licensedb.aboutcode.org/bsd-unchanged":                                                                                             "BSD-2-Clause-pos-unchanged",
	...
	"tunes.org/legalese/bugroff.html":                                                                                     "Bugroff",
	...
	"web.archive.org/web/20061013013632/http://opensource.linux-mirror.org/licenses/afl-2.1.txt":                          "AFL-2.1",
	...
	"www.nist.gov/open/copyright-fair-use-and-licensing-statements-srd-data-software-and-technical-series-publications": "NIST-Software",
	...
	"www.opensource.org/license/EPL-2.0":                                                                 "EPL-2.0",
