...
var licenseIDs = map[string]string{
	...
	"gpl-2.0.0-with-autoconf-exception":        "GPL-2.0-only WITH Autoconf-exception-2.0",
	"gpl-2.0.0-with-bison-exception":           "GPL-2.0-only WITH Bison-exception-2.2",
	"gpl-2.0.0-with-classpath-exception":       "GPL-2.0-only WITH Classpath-exception-2.0",
	"gpl-2.0.0-with-font-exception":            "GPL-2.0-only WITH Font-exception-2.0",
	"gpl-2.0.0-with-gcc-exception":             "GPL-2.0-only WITH GCC-exception-2.0",
	"gpl-3":                                    "GPL-3.0-only",
	"gpl-3+":                                   "GPL-3.0-or-later",
	"gpl-3-only":                               "GPL-3.0-only",
	"gpl-3-or-later":                           "GPL-3.0-or-later",
	"gpl-3-with-autoconf-exception":            "GPL-3.0-only WITH Autoconf-exception-3.0",
	"gpl-3-with-gcc-exception":                 "GPL-3.0-only WITH GCC-exception-3.1",
	...
	"gpl-3.0.0-with-autoconf-exception":        "GPL-3.0-only WITH Autoconf-exception-3.0",
	"gpl-3.0.0-with-gcc-exception":             "GPL-3.0-only WITH GCC-exception-3.1",
