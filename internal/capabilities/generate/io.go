...
func loadCapabilities(catalogerDir string) (*capabilities.Document, map[string]*yaml.Node, error) {

	// load all cataloger/*/capabilities.yaml files
	files, err := filepath.Glob("*/capabilities.yaml")
	if err != nil {
	...
	appconfigPath := filepath.Join(catalogerDir, "appconfig.yaml")
