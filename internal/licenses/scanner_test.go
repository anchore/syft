...
func TestIdentifyLicenseIDs(t *testing.T) {
   ...
   limitations under the License.`,
		...
		{
			name: "custom license",
			in:   "NVIDIA Software License Agreement and CUDA Supplement to Software License Agreement",
			expected: expectation{
				yieldError: false,
				ids:        []string{},
				content:    []byte("NVIDIA Software License Agreement and CUDA Supplement to Software License Agreement"),
			},
		},
	}
