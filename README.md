...
### Attaching an SBOM to an image as an attestation
...
[grype](https://github.com/anchore/grype) as one such tool. One of the foundational approaches to "trust" between tools
is for producers to use the artifacts generated by syft as attestations to their images. The SBOM output of syft can be used with the [cosign](https://github.com/sigstore/cosign) 
tool to generate an attestation that is attached to a signed image.
