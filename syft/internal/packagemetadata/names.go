...
var jsonNameFromType = map[reflect.Type][]string{
	...
	reflect.TypeOf(pkg.DotnetPortableExecutableMetadata{}): nameList("dotnet-portable-executable"),
	...
	reflect.TypeOf(pkg.SwiftPackageManagerMetadata{}):      nameList("swift-package-manager-lock", "SwiftPackageManagerMetadata"),
