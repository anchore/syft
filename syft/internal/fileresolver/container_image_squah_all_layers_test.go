...
func TestImageSquashAllLayersResolver_FilesByPath(t *testing.T) {
	cases := []struct {
		name                 string
		linkPath             string
		resolveLayer         uint
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			...
			resolver, err := NewFromContainerImageSquashAllLayers(img)
...
func TestImageSquashAllLayersResolver_FilesByGlob(t *testing.T) {
	cases := []struct {
		name         string
		glob         string
		resolveLayer uint
...
func Test_ImageSquashAllLayersResolver_FilesByMIMEType(t *testing.T) {
...
func Test_ImageSquashAllLayersResolver_hasFilesystemIDInLocation(t *testing.T) {
...
func TestSquashWithAllLayersImageResolver_FilesContents(t *testing.T) {
...
func TestSquashWithAllLayersImageResolver_FilesContents_errorOnDirRequest(t *testing.T) {
	...
	for loc := range resolver.AllLocations(ctx) {
		entry, err := resolver.squashed.img.FileCatalog.Get(loc.Reference())
		require.NoError(t, err)
...
func Test_ImageSquashAllLayersResolver_resolvesLinks(t *testing.T) {
	tests := []struct {
		name     string
...
func TestSquashWithAllLayersResolver_AllLocations(t *testing.T) {
