...
func TestDirectoryResolver_MultipleFilesByPath(t *testing.T) {
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			resolver, cleanupFn, err := NewFromDirectory("./test-fixtures", "", 0)
			require.NoError(t, err)
			require.NotNil(t, resolver)
			t.Cleanup(func() {
				require.NoError(t, cleanupFn())
...
func TestDirectoryResolver_FilesByGlobRecursive(t *testing.T) {
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/image-symlinks", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func TestDirectoryResolver_FilesByPath_ResolvesSymlinks(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-simple", "", 0)
			require.NoError(t, err)
			require.NotNil(t, resolver)
			t.Cleanup(func() {
				require.NoError(t, cleanupFn())
...
func TestDirectoryResolverDoesNotIgnoreRelativeSystemPaths(t *testing.T) {
	...
	resolver, cleanupFn, err := NewFromDirectory("test-fixtures/system_paths/target", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func Test_IndexingNestedSymLinks_ignoredIndexes(t *testing.T) {
	...
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-simple", "", 0, filterFn)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func Test_IndexingNestedSymLinksOutsideOfRoot(t *testing.T) {
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-multiple-roots/root", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func Test_RootViaSymlink(t *testing.T) {
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinked-root/nested/link-root", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func Test_SymlinkLoopWithGlobsShouldResolve(t *testing.T) {
	test := func(t *testing.T) {
		resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-loop", "", 0)
		require.NoError(t, err)
		require.NotNil(t, resolver)
		t.Cleanup(func() {
			require.NoError(t, cleanupFn())
...
func Test_directoryResolver_resolvesLinks(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-from-image-symlinks-fixture", "", 0)
			require.NoError(t, err)
			require.NotNil(t, resolver)
			t.Cleanup(func() {
				require.NoError(t, cleanupFn())
...
func TestDirectoryResolver_DoNotAddVirtualPathsToTree(t *testing.T) {
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/symlinks-prune-indexing", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
...
func TestDirectoryResolver_FilesContents_errorOnDirRequest(t *testing.T) {
	...
	resolver, cleanupFn, err := NewFromDirectory("./test-fixtures/system_paths", "", 0)
	require.NoError(t, err)
	require.NotNil(t, resolver)
	t.Cleanup(func() {
		require.NoError(t, cleanupFn())
