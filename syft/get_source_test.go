...
func TestValidateSourcePlatform(t *testing.T) {
	...
	t.Run("nil platform config", func(t *testing.T) {
		tests := []struct {
			name string
			cfg  *GetSourceConfig
		}{
	...
	t.Run("supported metadata types", func(t *testing.T) {
	...
	t.Run("unsupported metadata types", func(t *testing.T) {
		cfg := &GetSourceConfig{
			SourceProviderConfig: &sourceproviders.Config{
				Platform: &image.Platform{
					Architecture: "amd64",
	...
	t.Run("both platform and source present with valid metadata", func(t *testing.T) {
		cfg := &GetSourceConfig{
			SourceProviderConfig: &sourceproviders.Config{
				Platform: &image.Platform{
					Architecture: "amd64",
