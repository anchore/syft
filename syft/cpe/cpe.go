...
// SourcedCPE contains the attributes of an NVD CPE and a string
// describing where Syft got the CPE, e.g. generated by heuristics
...
func (c CPE) WithNVDDictionarySource() SourcedCPE {
	return SourcedCPE{
		CPE:    c,
...
func (c CPE) WithUnknownSource() SourcedCPE {
	return SourcedCPE{CPE: c}
}

func (c CPE) WithDeclaredSource() SourcedCPE {
	return SourcedCPE{
		CPE:    c,
		Source: "declared",
	}
...
func (c CPE) WithSource(source string) SourcedCPE {
	return SourcedCPE{
		CPE:    c,
		Source: source,
	}
