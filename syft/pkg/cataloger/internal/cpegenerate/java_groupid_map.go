...
var DefaultArtifactIDToGroupID = map[string]string{
	...
	// Older tomcat versions did not prefix these with tomcat- however there is enough
	// vulnerability data for these particular ones to justify an explicit mapping here
	// until a true maven groupid/artifactid index by digest can be created.
	"catalina":                                                 "org.apache.tomcat",
	"catalina-ant":                                             "org.apache.tomcat",
	"catalina-ha":                                              "org.apache.tomcat",
	"coyote":                                                   "org.apache.tomcat",
