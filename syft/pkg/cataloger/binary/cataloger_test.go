	...
	tests := []struct {
		...
		},
		{
			...
			expected: pkg.Package{
				...
				Version:   "1.24.11",
				Type:      "binary",
				PURL:      "pkg:golang/kubectl@1.24.11",
		...
		},
		{
			...
			expected: pkg.Package{
				...
				Version:   "1.25.7",
				Type:      "binary",
				PURL:      "pkg:golang/kubectl@1.25.7",
				Locations: locations("kubectl"),
				Metadata:  metadata("kubectl"),
			},
		},
		{
			...
			expected: pkg.Package{
				...
				Version:   "1.26.2",
				Type:      "binary",
				PURL:      "pkg:golang/kubectl@1.26.2",
				Locations: locations("kubectl"),
				Metadata:  metadata("kubectl"),
			},
		},
		{
			...
			expected: pkg.Package{
				...
				Version:   "4.5.7",
				Type:      "binary",
				PURL:      "pkg:golang/kustomize@4.5.7",
		...
		},
		{
			...
			expected: pkg.Package{
				...
				Version:   "5.0.0",
				Type:      "binary",
				PURL:      "pkg:golang/kustomize@5.0.0",
				Locations: locations("kustomize"),
				Metadata:  metadata("kustomize"),
			},
		},
