...
func newStaticLicenses(opts StaticBinaryCatalogerOpts) staticLicenses {
	return staticLicenses{
		...
		progress: &monitor.CatalogerTask{
			...
			//TODO: UPDATE THIS
			Title: "UPDATE ME TO SOMETHING APPROPRIATE",
		},
	}
}
...
func (c *staticLicenses) getLicenses(resolver file.Resolver, filename string, location string) (licenses []pkg.License, err error) {

	//UPDATE THIS
	licenses, err = findLicenses(resolver, filename, location)
...
/*func (c *staticLicenses) getLicensesFromLocal(moduleName, moduleVersion string) ([]pkg.License, error) {
...
/*func (c *staticLicenses) getLicensesFromRemote(moduleName, moduleVersion string) ([]pkg.License, error) {
...
func findLicenses(resolver file.Resolver, globMatch string, location string) (out []pkg.License, err error) {
