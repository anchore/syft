	...
	tests := []struct {
	...
	}{
		{
			...
			expectedPkgs: []string{
				...
				"github.com/mholt/archives @ v0.1.5 (/run-me)",
			},
			expectedRels: []string{
				...
				"github.com/mholt/archives @ v0.1.5 (/run-me) [dependency-of] anchore.io/not/real @ v1.0.0 (/run-me)",
		...
		},
		{
			...
			expectedRels: []string{
				"github.com/mholt/archives @ v0.1.5 (/run-me) [dependency-of] command-line-arguments @  (/run-me)",
