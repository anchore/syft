	...
	expectedPkgs := []pkg.Package{
		{
			...
			Language:     pkg.Python,
			Type:         pkg.PythonPkg,
			MetadataType: "PythonPackagePipfileMetadata",
			Metadata:     PipfileMetadata{Index: "https://pypi.org/simple"},
		},
		{
			Name:         "aiodns",
			Version:      "2.0.0",
			...
			Type:         pkg.PythonPkg,
			MetadataType: "PythonPackagePipfileMetadata",
			Metadata:     PipfileMetadata{Index: "https://test.pypi.org/simple"},
		},
		{
			Name:         "aiohttp",
			Version:      "3.7.4.post0",
