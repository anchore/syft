...
func TestParsePackageLockV2(t *testing.T) {
	...
	expectedPkgs := []pkg.Package{
		...
		},
		{
			...
			Licenses:     []string{"MIT"},
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/@types/prop-types/-/prop-types-15.7.5.tgz"},
		},
		{
			Name:         "@types/react",
			Version:      "18.0.17",
			...
			Licenses:     []string{"MIT"},
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/@types/react/-/react-18.0.17.tgz"},
		},
		{
			...
			Licenses:     []string{"MIT"},
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/@types/scheduler/-/scheduler-0.16.2.tgz"},
		},
		{
			Name:         "csstype",
			Version:      "3.1.0",
			...
			Licenses:     []string{"MIT"},
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/csstype/-/csstype-3.1.0.tgz"},
		},
	}
	for i := range expectedPkgs {
		expectedPkgs[i].Locations.Add(source.NewLocation(fixture))
...
func TestParsePackageLockV3(t *testing.T) {
	...
	expectedPkgs := []pkg.Package{
		...
		},
		{
			...
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/@types/react/-/react-18.0.20.tgz"},
		},
		{
			Name:         "@types/scheduler",
			Version:      "0.16.2",
		...
		},
		{
			...
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/csstype/-/csstype-3.1.1.tgz"},
		},
	}
	for i := range expectedPkgs {
		expectedPkgs[i].Locations.Add(source.NewLocation(fixture))
	...
	commonPkgs := []pkg.Package{
		{
			...
			Type:         pkg.NpmPkg,
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/case/-/case-1.6.2.tgz"},
		},
		{
			Name:         "case",
			Version:      "1.6.3",
			...
			Type:         pkg.NpmPkg,
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/case/-/case-1.6.3.tgz"},
		},
		{
			...
			Type:         pkg.NpmPkg,
			MetadataType: "NpmPackageLockJsonMetadata",
			Metadata:     NpmMetadata{Resolved: "https://registry.npmjs.org/@bundled-es-modules/chai/-/chai-4.2.2.tgz"},
		},
	}
