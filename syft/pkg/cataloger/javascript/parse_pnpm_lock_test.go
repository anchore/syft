...
// which silently dropped every other package from the SBOM (anchore/syft#5241). The
// runtime itself is not an npm package, so it is skipped rather than cataloged.
