	...
	}{
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Isaac Z. Schlueter","email":"i@izs.me","url":""}]`,
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Raynos","email":"raynos2@gmail.com","url":""},{"name":"Raynos","email":"","url":""},{"name":"Jordan Harband","email":"","url":""}]`,
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"npm Inc.","email":"","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Harry Potter","email":"hp@hogwards.com","url":""},{"name":"John Smith","email":"j.smith@something.com","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Isaac Z. Schlueter","email":"i@izs.me","url":""},{"name":"Harry Potter","email":"hp@hogwards.com","url":""},{"name":"John Smith","email":"j.smith@something.com","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Alice Contributor","email":"alice@example.com","url":""},{"name":"Bob Helper","email":"bob@example.com","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					...
					Authors:     `[{"name":"Charlie Maintainer","email":"charlie@example.com","url":""},{"name":"Diana Keeper","email":"diana@example.com","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
		...
		},
		{
			...
			ExpectedPkg: pkg.Package{
				...
				Metadata: pkg.NpmPackage{
					Name:        "npm",
					Version:     "6.14.6",
					Author:      "Main Author <main@example.com>, Second Author <second@example.com>, Contrib One <contrib1@example.com>, Contrib Two <contrib2@example.com>, Maintainer One <maintain1@example.com>",
					Authors:     `[{"name":"Main Author","email":"main@example.com","url":""},{"name":"Second Author","email":"second@example.com","url":""},{"name":"Contrib One","email":"contrib1@example.com","url":""},{"name":"Contrib Two","email":"contrib2@example.com","url":""},{"name":"Maintainer One","email":"maintain1@example.com","url":""}]`,
					Homepage:    "https://docs.npmjs.com/",
					URL:         "https://github.com/npm/cli",
					Description: "a package manager for JavaScript",
				},
