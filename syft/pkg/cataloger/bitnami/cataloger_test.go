...
func TestBitnamiCataloger(t *testing.T) {
	...
	postgresqlMainPkg := pkg.Package{
		...
		Licenses: pkg.NewLicenseSet(
			pkg.NewLicenseFromType(ctx, "PostgreSQL", license.Concluded),
			pkg.NewLicenseFromType(ctx, "PostgreSQL", license.Declared),
		),
	...
	postgresqlSecondaryPkgs := []pkg.Package{
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "LGPL-2.1-only", license.Concluded),
				pkg.NewLicenseFromType(ctx, "LGPL-2.1-only", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "MIT", license.Concluded),
				pkg.NewLicenseFromType(ctx, "MIT", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "0BSD", license.Concluded),
				pkg.NewLicenseFromType(ctx, "0BSD", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "BSD-3-Clause", license.Concluded),
				pkg.NewLicenseFromType(ctx, "BSD-3-Clause", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "LGPL-3.0-only", license.Concluded),
				pkg.NewLicenseFromType(ctx, "LGPL-3.0-only", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "BSD-2-Clause", license.Concluded),
				pkg.NewLicenseFromType(ctx, "BSD-2-Clause", license.Declared),
			),
			FoundBy: catalogerName,
		...
		},
		{
			...
			Locations: file.NewLocationSet(file.NewLocation("opt/bitnami/postgresql/.spdx-postgresql.spdx")),
			Licenses: pkg.NewLicenseSet(
				pkg.NewLicenseFromType(ctx, "GPL-2.0-or-later", license.Concluded),
				pkg.NewLicenseFromType(ctx, "GPL-2.0-or-later", license.Declared),
			),
			FoundBy: catalogerName,
	...
	renderTemplateMainPkg := pkg.Package{
		...
		Licenses: pkg.NewLicenseSet(
			pkg.NewLicenseFromType(ctx, "Apache-2.0", license.Concluded),
			pkg.NewLicenseFromType(ctx, "Apache-2.0", license.Declared),
		),
		FoundBy: catalogerName,
	...
	redisMainPkg := pkg.Package{
		...
		Licenses: pkg.NewLicenseSet(
			pkg.NewLicenseFromType(ctx, "RSALv2", license.Concluded),
			pkg.NewLicenseFromType(ctx, "RSALv2", license.Declared),
		),
		FoundBy: catalogerName,
