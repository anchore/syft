...
// LinuxKernelPackageMetadata represents all captured data for a Linux kernel
type LinuxKernelPackageMetadata struct {
	...
	Modules         []LinuxKernelModuleMetadata `mapstructure:"modules" json:"modules" cyclonedx:"modules"`
}

func (m LinuxKernelPackageMetadata) OwnedFiles() (result []string) {
	s := strset.New()
