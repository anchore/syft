...
// RpmArchiveMetadata represents all captured data from a RPM package archive.
type RpmArchiveMetadata RpmDBMetadata

// RpmDBMetadata represents all captured data from a RPM DB package entry.
