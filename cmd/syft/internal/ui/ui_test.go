...
func Test_UI_viewEndsOnAnEmptyLine(t *testing.T) {
	...
	// carries content loses it. Unless a log line happened to be in the footer, that dropped the last row
	// of the cataloging tree on any source that logs nothing.
